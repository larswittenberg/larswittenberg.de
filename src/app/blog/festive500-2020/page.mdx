...
export const metadata = {
	...
	description: 'Mein Bericht zur Festive500 Herausforderung - 500km Fahrradfahren zwischen Heiligabend und Silvester'
};
...
[Go Solo von Tom Rosenthal auf Spotify](https://open.spotify.com/track/18ywhG9EvuMMUIdUWxEqp7)
