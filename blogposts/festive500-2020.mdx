...
<FlexWrapper>
	<iframe src="https://open.spotify.com/embed/track/18ywhG9EvuMMUIdUWxEqp7" width="300" height="80" frameBorder="0" allowtransparency="true" allow="encrypted-media" className="block mx-4"></iframe>
	<div className="not-prose">
		<p>Passend gewählter Song von Rapha für dieses Corona-Jahr 2020.</p>
	</div>
</FlexWrapper>
